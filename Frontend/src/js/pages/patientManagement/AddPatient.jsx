            ...
            {openPopUp && (
                <div className='grid fixed top-1/2 left-1/2 transform -translate-x-1/3 -translate-y-1/2 w-full max-w-[750px] h-[560px] bg-[#4E5C82] text-white p-8 z-50'>
                    ...
                    <form
                        ...
                        <div className='grid col-span-2 content-center'>
                            <label htmlFor='age' className=''>Edad:</label>
                            <input
                              type='number'
                              name='age'
                              value={values.age}
                              ...
                              max='99'
                              onChange={handleOnChange}
                              className='bg-[#EEEEEE] col-start-2 max-w-[200px] h-[40px] ml-24 p-2 placeholder-[#939191] text-[#616060]'
                            />
                        </div>
                        <div className='grid col-span-2 content-center'>
                        ...
                        <div className='col-span-4'>
                            <label htmlFor='diagnosis' className=''>Diagnóstico:</label>
                            <textarea
                              type='text'
                              name='diagnosis'
                              ...
                              onChange={handleOnChange}
                              className='bg-[#EEEEEE] w-full h-[100px] p-2 placeholder-[#939191] text-[#616060]'
                            />
                        </div>
