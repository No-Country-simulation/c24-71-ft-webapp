...
const ListPatients = () => {
  return (
    <div className='grid grid-cols-[0.70fr_5.6fr_0.85fr] grid-rows-[1fr_4.5fr_1fr]'>
          ...
          <ul className='grid grid-cols-[0.95fr_1fr_1fr_0.4fr_0.2fr] text-[#3F4B6E] text-xl font-semibold justify-between px-10'>
            <li>DNI</li>
            <li>Nombre y Apellido</li>
            <li className='text-center pr-56'>Edad</li>
            <li className='text-center pr-46'>Mail</li>
            <li>Acciones</li>
          </ul>
        </div>
